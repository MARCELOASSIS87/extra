          ...
          return (
            <li key={item.href}>
              <Link
                ...
                className={`focus-visible:ring-ring flex h-16 flex-col items-center justify-center gap-1 text-xs font-medium focus-visible:outline-none focus-visible:-outline-offset-2 focus-visible:ring-2 ${
